...
__webpack_require__.d(__webpack_exports__, {
  ...
  "VerifyApi": () => (/* binding */ backend_VerifyApi)
});
...
/** @internal */
var HEADER_NAME_API_KEY = 'X-Api-Key';
/**
 ...
 */
var backend_VerifyApi = /** @class */ (function (_super) {
     ...
     * @param enableLogging Whether to enable logging or not
     */
    function VerifyApi(apiKey, baseUrl, enableLogging) {
        if (baseUrl === void 0) { baseUrl = 'https://api.fixture.ai'; }
        if (enableLogging === void 0) { enableLogging = false; }
        var _this = _super.call(this, baseUrl, enableLogging) || this;
     ...
     */
    VerifyApi.prototype.createSession = function () {
        var _a;
        var _this = this;
        return fetch(this._baseUrl + "/session", {
            method: 'POST',
            headers: (_a = {}, _a[HEADER_NAME_API_KEY] = this._apiKey, _a)
        }).then(function (response) {
            if (!response.ok) {
                throw new Error(response.statusText);
            }
            return response.json().then(function (json) {
                _this._log && console.debug("Created session " + json.id);
                return json.id;
            });
        });
    };
     ...
     */
    VerifyApi.prototype.getSession = function (sessionId) {
        var _a;
        var _this = this;
        return fetch(this._baseUrl + "/session/" + sessionId, {
            headers: (_a = {}, _a[HEADER_NAME_API_KEY] = this._apiKey, _a)
            ...
            return response.json().then(function (json) {
                var session = new Session(json.id, json.status, json.score);
                _this._log && console.debug("Fetched session " + session.id, session);
                return session;
            });
        });
    };
